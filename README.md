Pacman-Clone with ThinkEngine AI
============
...
The original clone has been modified by adding three ASP-based planning brains driving the PacMan by means of ThinkEngine.
